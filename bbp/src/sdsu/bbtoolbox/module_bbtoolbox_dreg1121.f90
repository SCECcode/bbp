...
!
! Updated: December 2021 [kxu4143@sdsu.edu]
!   Moved the not-using Tr_sca parameter to dreg_stf
!
use def_kind
...
! (previous) scaling factor for stf_new: t1 = Tr_sca * Tr
! scaling factor for stf_dreg: tau = Tr_sca * Tr
